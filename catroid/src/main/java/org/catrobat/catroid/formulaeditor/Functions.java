...
public enum Functions {
    ...
    F2D_IS_TOUCHED, F2D_IS_TOUCHED_INDEX,  VOXEL_GET_ID, VOXEL_GET_DATA, HTTP_RESPONSE_TEXT, HTTP_RESPONSE_CODE, HTTP_RESPONSE_HEADER, NOTIFICATION_REPLY,
    READ_FILE, MEDIA_DURATION, IMAGE_WIDTH, IMAGE_HEIGHT, FILE_LAST_MODIFIED, CAMERA_X, CAMERA_Y, CAMERA_ROTATION, CAMERA_ZOOM, CLIPBOARD_TEXT, MQTT_MESSAGE,
    FILE_TO_BASE64, MD5, SHA256, FILE_MD5, FILE_SHA256, PT_SAMPLE, CHAR_TO_UNICODE, UNICODE_TO_CHAR, UNESCAPE_UTF;
	...
	public static EnumSet<Functions> TEXT = EnumSet.of(INTERSECT_LIST, COLLISION_LIST, DELTA, LENGTH, LETTER, SUBTEXT, CLAMP, TO_HEX, TO_DEC, DISTAN, UPPER, LOWER, REVERSE, VAR, VARNAME, VARVALUE, JOIN, JOIN3, REPLACE, CONTAINS_STR, REPEAT, RANDOM_STR, JOINNUMBER,
			...
			GET_3D_VELOCITY_X, GET_3D_VELOCITY_Y, GET_3D_VELOCITY_Z, GET_CAMERA_ROTATION_YAW, GET_CAMERA_ROTATION_PITCH, GET_CAMERA_ROTATION_ROLL, OBJECT_TOUCHES_OBJECT, JSON_GET, JSON_SET, GET_RAY_HIT_X, GET_RAY_HIT_Y, GET_RAY_HIT_Z, GET_RAY_HIT_NORMAL_X, GET_RAY_HIT_NORMAL_Y, GET_RAY_HIT_NORMAL_Z,
			IS_MOUSE_BUTTON_DOWN, OBJECT_INTERSECTS_OBJECT, PT_ARGMAX, PT_VALUE, PT_VALUEND, PT_SHAPE, PT_DUMP, PT_TOTALSIZE,
            F2D_X, F2D_Y, F2D_ROTATION, F2D_SCALE_X, F2D_SCALE_Y,
            F2D_COLOR_R, F2D_COLOR_G, F2D_COLOR_B, F2D_ALPHA,
            F2D_TEXTURE, F2D_CAM_X, F2D_CAM_Y, F2D_CAM_ZOOM,
            F2D_IS_TOUCHED, F2D_IS_TOUCHED_INDEX,  VOXEL_GET_ID, VOXEL_GET_DATA, HTTP_RESPONSE_TEXT, HTTP_RESPONSE_CODE, HTTP_RESPONSE_HEADER,
            NOTIFICATION_REPLY, READ_FILE, CAMERA_X, CAMERA_Y, CAMERA_ROTATION, CAMERA_ZOOM, CLIPBOARD_TEXT, MQTT_MESSAGE, FILE_TO_BASE64,
            MD5, SHA256, FILE_MD5, FILE_SHA256, PT_SAMPLE, CHAR_TO_UNICODE, UNICODE_TO_CHAR, UNESCAPE_UTF);
	...
	public static final EnumSet<Functions> BOOLEAN = EnumSet.of(TRUE, FALSE, CONTAINS,
			MULTI_FINGER_TOUCHED, COLLIDES_WITH_COLOR, COLOR_TOUCHES_COLOR, COLOR_EQUALS_COLOR, RAY_DID_HIT, OBJECT_INTERSECTS_OBJECT, OBJECT_TOUCHES_OBJECT, JSON_IS_VALID);
