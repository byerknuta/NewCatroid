...
public class ShowTextColorSizeAlignmentAction extends Action {
    private Formula xPosition, yPosition, relativeTextSize, color;
    ...
    public boolean act(float delta) {
        try {
            ...
            if (targetActor == null) {
                ...
                targetActor.updateProperties(targetActor.getVariableNameToCompare(), xPos, yPos, relSize, colStr, null);
            }
        } catch (InterpretationException e) {
            Log.d("ShowTextColorSize", "InterpretationException: " + e);
        }
        return true;
    }
